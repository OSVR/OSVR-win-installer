...
Section "EndInstall" SEC04
 ...
 ${TimeStamp} $0
  ...
  nsExec::ExecToStack /timeout=5000 '${APP_INSTALL_DIR}\bin\${SERVICE_FILE_NAME} -install'
 ${TimeStamp} $0
  LogEx::Write true true "$0:Starting service"
  nsExec::ExecToStack /timeout=5000 '${APP_INSTALL_DIR}\bin\${SERVICE_FILE_NAME} -start'
 SectionEnd
